  ...
  const handleFile = async (e) => {
    ...
    try {
      ...
      const importedQuestions = rawJson.map((row, idx) => {
        ...
        // remove empty options but keep at least 2
      ...
      setQuestions(importArr);
      setImportStatus(
        `Imported ${importedQuestions.length} questions. Sending to server...`
      );
      validateAllQuestions(importArr);
      ...
      setImportStatus(
        "Failed to parse Excel file. Make sure the headers are correct."
      );
    } finally {
    ...
    <div className="max-w-6xl mx-auto p-6 space-y-8 bg-gray-50 min-h-screen">
      ...
      {questions.map((q, qi) => (
        ...
        >
          ...
          <div className="space-y-2">
            ...
            <textarea
              id={`question-${qi}`}
              className={`w-full p-3 border rounded-lg bg-white text-gray-900 placeholder-gray-500 focus:ring-2 focus:ring-blue-400 focus:border-transparent hover:shadow-md transform hover:scale-[1.01] transition-all duration-200 resize-none ${
            ...
            {q.options.map((opt, oi) => (
              <div key={oi} className="flex items-center space-x-3 group">
                ...
                <input
                  ...
                  className={`flex-grow px-3 py-2 border rounded-lg bg-white text-gray-900 focus:ring-2 focus:ring-blue-400 focus:border-transparent hover:shadow-md transition-all duration-200 ${
      ...
      <div className="flex space-x-4 justify-end">
        ...
        <button
          ...
          className={`flex items-center justify-center px-6 py-3 rounded-lg text-white transition-all duration-200 ${
